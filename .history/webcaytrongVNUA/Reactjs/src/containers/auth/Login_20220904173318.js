            ...
            <div className="login-container">
                <div className="login-content row">
                    ...
                    <div className="col-12 form-group login-input">
                        ...
                        <input type={this.state.is} className="form-control" placeholder="Enter your password"value={this.state.password} onChange={(event)=>this.handleOnChangePassword(event)} ></input>
