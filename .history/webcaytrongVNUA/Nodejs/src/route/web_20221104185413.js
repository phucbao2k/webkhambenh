...
export function initWebRoutes(app) {
    ...
    router.get('/api/get-all-handbooks', handbookController.handleGetAllSpecialties);
    router.put('/api/edit-handbook', handbookController.handleEditSpecialty);
    router.delete('/api/delete-handbook', handbookController.handleDeleteSpecialty);
