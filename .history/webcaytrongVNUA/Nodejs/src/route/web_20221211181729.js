...
//admin-booking
    router.post('/api/cancel-paid-booking', patientController.cancelPatientRemedy);
    router.get('/api/get-all-booking-for-admin-booking', adminController.getAllBookingForAdmin);
    router.get('/api/get-all-paid-booking-for-admin-booking', adminController.handleGetAllBookings);
