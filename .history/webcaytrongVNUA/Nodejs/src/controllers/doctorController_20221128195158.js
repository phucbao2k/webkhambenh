...
let getHistoryPatientForDoctor = async (req, res) => {
    try {
        let infor = await doctorService.getHistoryPatientForDoctor(req.query.doctorId);
        return res.status(200).json(infor);
    } catch (e) {
        console.log(e);
        return res.status(200).json({
...
module.exports = {
    ...
    getHistoryPatientForDoctor: getHistoryPatientForDoctor
}