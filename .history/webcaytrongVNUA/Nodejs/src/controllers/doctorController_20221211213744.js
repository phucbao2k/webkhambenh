...
let getListBookingForDoctor = async (req, res) => {
    try {
        let infor = await doctorService.getListBookingForAdminBooking(req.query.statusId, req.query.date);
        return res.status(200).json(infor);
    } catch (e) {
        console.log(e);
        return res.status(200).json({
...
let getListPaidBookingForAdminBooking = async (req, res) => {
    try {
        let infor = await doctorService.getListPaidBookingForAdminBooking(req.query.statusId, req.query.date);
        return res.status(200).json(infor);
    } catch (e) {
        console.log(e);
        return res.status(200).json({
