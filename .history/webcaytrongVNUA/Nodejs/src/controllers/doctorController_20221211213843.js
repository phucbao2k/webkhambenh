...
let getListDoneBookingForDoctor = async (req, res) => {
    try {
        let infor = await doctorService.getListBookingForAdminBooking(req.query.statusId, req.query.date, req.query.doctorId);
        return res.status(200).json(infor);
    } catch (e) {
        console.log(e);
        return res.status(200).json({
...
let getListPaidBookingForDoctor = async (req, res) => {
    try {
        let infor = await doctorService.getListPaidBookingForAdminBooking(req.query.statusId, req.query.date, req.query.doctorId);
        return res.status(200).json(infor);
    } catch (e) {
        console.log(e);
        return res.status(200).json({
