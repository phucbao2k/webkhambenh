...
let getBodyHTMLEmailReRemedy = (dataSend) => {
    ...
    if (dataSend.language === 'vi') {
        result =
            `
        <h3> Xin chào ${dataSend.patientName} !</h3 >
        <p>Bạn nhận được thư này vì đã thanh toán và nhận được phiếu khám khi tới cơ sở chăm sóc cây trồng</p>
     <p>Rất tiếc!Bác sĩ của chúng tôi chưa thể khám cho cây của bạn như đúng</p>
