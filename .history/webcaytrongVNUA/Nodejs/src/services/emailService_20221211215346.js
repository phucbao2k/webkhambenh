...
let getBodyHTMLEmailReRemedy = (dataSend) => {
    ...
    if (dataSend.language === 'vi') {
     ...
     <p>Nếu bạn muốn hoàn tiền, hãy liên hệ với chúng tôi trong thời gian sớm nhất. Rất hân hạnh được phục vụ</p>
     <p>Hotline: 0981943577 - Email hỗ trợ: phuclongchausa912</p>
       <div>Bạn có thể quản lý lịch khám bệnh cho cây của mình qua mục quản lý tài khoản</div>
         <div>Xin chân thành cảm ơn!</div>
