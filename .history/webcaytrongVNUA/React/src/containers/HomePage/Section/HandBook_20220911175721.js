                ...
                <div  className="section-container">
                    ...
                    <Slider {...this.props.settings}>
                        <div className="section-customize">
                            ...
                            <div>Cơ sở chăm sóc cây 1</div>
                        </div>
                        <div className="section-customize">
                        <div className="bg-image"></div>
                            <div>Cơ sở chăm sóc cây 2</div>
                        </div>
                        <div className="section-customize">
                        <div className="bg-image"></div>
                            <div>Cơ sở chăm sóc cây 3</div>
                        </div>
                        <div className="section-customize">
                        <div className="bg-image"></div>
                            <div>Cơ sở chăm sóc cây 4</div>
                        </div>
                        <div className="section-customize">
                        <div className="bg-image"></div>
                            <div>Cơ sở chăm sóc cây 5</div>
                        </div>
                        <div className="section-customize">
                        <div className="bg-image"></div>
                            <div>Cơ sở chăm sóc cây 6</div>
                        </div>
                    </Slider>
                    </div>
