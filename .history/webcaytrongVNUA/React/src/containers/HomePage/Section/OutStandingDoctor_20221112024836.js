...
class OutStandingDoctor extends Component {
   ...
   async componentDidMount() {
    ...
    render() {
        ...
        return (
            <div className="section-share section-outstanding-doctor  mb-5">
                        ...
                        <Slider {...settings}>
                            {arrDoctors && arrDoctors.length > 0 &&
                                arrDoctors.map((item, index) => {
                                    ...
                                    return (
                                        <div className="section-customize specialty-child" key={index} onClick={() => this.handleViewDetailDoctor(item)}>
