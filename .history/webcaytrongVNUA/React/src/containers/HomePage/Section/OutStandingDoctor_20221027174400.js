...
class OutStandingDoctor extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.topDoctorSpecialtyRedux !== this.props.topDoctorSpecialtRedux) {
            this.setState({
                arrDoctors: this.props.topDoctorRedux
            })
        }
   ...
   async componentDidMount() {
    ...
    render() {
        let {  dataSpecialty, arrDoctors } = this.state;
...
const mapStateToProps = state => {
    return {
        ...
        topDoctorSpecialtyRedux: state.admin.topDoctorsSpecialty
    };
};
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        loadTopDoctorsSpecialty: () => dispatch(actions.fetchTopDoctorSpecialty())
    };
};
