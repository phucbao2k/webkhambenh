...
class HomeHeader extends Component {
    constructor(props) {
        ...
        this.specialty = React.createRef();
        this.handbook = React.createRef();
        this.clinic = React.createRef();
        this.topdoctor = React.createRef();
    ...
    scrollToContent =(content) =>{
        switch (content) {
            case 1:
                this.specialty.current.scrollIntoView({ behavior: 'smooth' });
                break;
            case 2:
                this.handbook.current.scrollIntoView({ behavior: 'smooth' });
                break;
            case 3:
                this.clinic.current.scrollIntoView({ behavior: 'smooth' });
                break;
            case 4:
                this.topdoctor.current.scrollIntoView({ behavior: 'smooth' });
        }
    }
    changeActiveMenu = () => {
        this.setState({
            ...
            <React.Fragment>
                ...
                <div className={this.state.activeMenu == false ? 'left_menu' : 'left_menu active_menu'}>
                    ...
                    <div className='main-content'>
                        <Specialty goTo={this.scrollToContent} />
                        <HandBook goTo={this.scrollToContent} />
                        <MedicalFacility goTo={this.scrollToContent} />
                        <OutStandingDoctor goTo={this.scrollToContent} />
                        <a className='menu__item' href='./Section/HandBook' >
                            {/* <Specialty ref={this.specialty}/> */}
                        ...
                        <div className='menu__item' >
                            {/* <MedicalFacility ref={this.clinic}/> */}
                        ...
                        <div className='menu__item' >
                            {/* <OutStandingDoctor ref={this.topdoctor}/> */}
