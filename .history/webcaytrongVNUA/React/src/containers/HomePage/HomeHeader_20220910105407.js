...
import {LANGUAGE, languages, LanguageUtils} from '../../utils';
  ...
  <div className="home-header-container">
                <div className="home-header-content">
                    ...
                    <div className="right-content">
                        ...
                        <div className={language === languages.VI ?'language-vi active':'language-vi'}><span></span>VN</div>
                        <div className={language === languages.EN ?'language-en active':'language-en'}>EN</div>
                        </div>
