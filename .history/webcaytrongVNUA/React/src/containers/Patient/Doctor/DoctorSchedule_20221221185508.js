...
class DoctorSchedule extends Component {
    ...
    async componentDidMount() {
        ...
        if(this.props.doctorIdFromParent && this.props.priceIdFromParent){
            let res = await getScheduleDoctorByDate(this.props.doctorIdFromParent, allDays[0].value, this.props.priceIdFromParent);
            this.setState({
    ...
    async componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (this.props.doctorIdFromParent !== prevProps.doctorIdFromParent && this.props.priceIdFromParent !== prevProps.priceIdFromParent) {
            let allDays = this.getArrDays(this.props.language);
            let res = await getScheduleDoctorByDate(this.props.doctorIdFromParent, allDays[0].value, this.props.pr);
            this.setState({
                allAvailableTime: res.data ? res.data : []
            })
        }
