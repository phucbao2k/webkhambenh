...
class BookingModal extends Component {
    ...
    async componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.pric !== this.props.pric) {
            let { resPayment, resPrice, resProvince, resSpecialty, resClinic } = this.props.pric;
...
const mapDispatchToProps = dispatch => {
    return {
        getPriceStart: () => dispatch(actions.getPriceStart()),
    };
};
