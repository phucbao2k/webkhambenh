...
class BookingModal extends Component {
 ...
 // bất kỳ thứ gì chèn vào đầu vào đều có thể được truy cập thông qua event.target.value
    ...
    handleConfirmBooking = async () => {
       ...
       let doctorName = this.buildDoctorName(this.props.dataTime.d);
        ...
        let res = await postPatientBookAppointment({
            ...
            doctorName: this.props.dataTime.doctorName
        })
                        ...
                        <div className="booking-modal-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-6 form-group">
                                    ...
                                    <input
                                        onChange={(event) => this.handleOnChangeInput(event, 'doctorName')}
                                        value={this.buildDoctorName(dataTime)}
                                        disabled
                                        />
                                </div>
                                {/* <div className="col-6 form-group">
