...
priceId: priceId
 ...
 // bất kỳ thứ gì chèn vào đầu vào đều có thể được truy cập thông qua event.target.value
    ...
    buildPriceBooking = (dataPrice) => {
        let { language } = this.props;
        if (dataPrice && !_.isEmpty(dataPrice)) {

            let price = language === LANGUAGES.VI ? dataPrice.Doctor_Infor.priceTypeData.valueVi.valueVi : dataPrice.Doctor_Infor.priceTypeData.valueVi.valueEn;
    ...
    handleConfirmBooking = async () => {
     ...
     let price = this.buildPriceBooking(this.props.dataPrice);
  ...
  price: price
    ...
    render() {
        let { isOpenModal, closeBookingClose, dataTime, dataPrice } = this.props;
                            ...
                            <div className="row">
                                ...
                                <div className="col-4 form-group">
                                    ...
                                    <input className="form-control"
                                        ...
                                        value= {this.buildPriceBooking(dataPrice)} />
                                </div>
                            </div>
                        </div>
