...
class BookingModal extends Component {
 ...
 // bất kỳ thứ gì chèn vào đầu vào đều có thể được truy cập thông qua event.target.value
    ...
    handleConfirmBooking = async () => {
        ...
        let price = this.buildPriceBooking(this.props.dataProfile.Doctor_Infor.priceTypeData);
        ...
        let res = await postPatientBookAppointment({
            ...
            priceId: this.props.dataProfile.Doctor_Infor.priceTypeData,
    ...
    render() {
      ...
      let {dataProfile} = this.state;
        console.log('dataProfile', this.props.dataProfile.Doctor_Infor.priceTypeData);
        let doctorId = '';
        let priceId = '';
        if (dataTime && !_.isEmpty(dataTime)) {
