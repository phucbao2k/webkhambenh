...
import { postPatientBookAppointment, getExtraInforDoctorById } from "../../../../services/userService";
...
class BookingModal extends Component {
 ...
 // bất kỳ thứ gì chèn vào đầu vào đều có thể được truy cập thông qua event.target.value
    ...
    render() {
        let { isOpenModal, closeBookingClose, dataTime, extraInfor } = this.props;
        console.log('check data extra', extraInfor);
        let doctorId = '';
        if (dataTime && !_.isEmpty(dataTime)) {
