...
class DetailDoctor extends Component {
 ...
 if (detailPrice && detailPrice.Doctor_Infor && detailPrice.Doctor_Infor.priceTypeData) {
            priceId = detailPrice.Doctor_Infor.priceTypeData;
        }
                this.setState({
 ...
 priceId: detailPrice.Doctor_Infor.priceTypeData,
    ...
    render() {
        ...
        //     price = detailDoctor.Doctor_Infor.priceTypeData;
        // }
                    ...
                    <div className="container schedule-doctor">
                        <div className="content-left">
                            <DoctorSchedule
                                ...
                                priceIdFromParent={this.state.detailDoctor.Doctor_Infor.price}
                            />
                        </div>
                        <div className="content-right">
