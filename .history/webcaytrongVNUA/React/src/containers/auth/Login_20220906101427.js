...
handleLogin = async () =>{
  this.setState({
    ...
    // bị lỗi, lần nhập thông tin sau sẽ hiện ra mã lỗi khác 
  })
  try{
                ...
                <div className="login-content row">
                    ...
                    <div className="col-12 form-group login-input">
                        ...
                        <span onClick ={()=>{this.handleShowHidePassword()}}>
                            ...
                            <i class={this.state.isShowPassword ? 'fa-solid fa-eye' :'fa-regular fa-eye-slash'}></i>
                            </span>
                    ...
                    <div className="col-12" style={{color:'red'}}>  go
