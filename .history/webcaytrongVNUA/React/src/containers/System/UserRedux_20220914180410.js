...
componentDidUpdate( prevProps,prevState, snapshot){
    if(prevProps.genderRedux !== this.props.genderRedux && prevProps.positionRedux !== this.props.positionRedux && prevProps.roleIdRedux !== this.props.roleIdRedux && prevProps.roleId){
        this.setState({
