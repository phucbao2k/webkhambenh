...
class TableManageSpecialty extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.listSpecialt !== this.props.listSpecialt) {
            this.setState({
                specialtiesRedux: this.props.listSpecialt,
            })
        }
    }
    ...
    render() {
        ...
        let arrSpecialt = this.state.specialtiesRedux;
                    ...
                    <div className="users-table mt-3 mx-1">
                        <table id="TableManageSpecialty">
                            <tbody>
                                ...
                                {arrSpecialt && arrSpecialt.length > 0 && arrSpecialt.map((item, index) => {
