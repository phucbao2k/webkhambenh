...
class ManagePatients extends Component {
    ...
    async componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.bookingRedux !== this.props.bookingRedux) {
            let arrClinics = this.props.bookingRedux;
            this.setState({
                bookingArr: arrClinics,
                booking: arrClinics && arrClinics.length > 0 ? arrClinics[0].keyMap : '',
            })
        }
                                                ...
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button className="mp-btn-confirm" onClick={() => this.handleEditUserFromParent(item)}>Xem chi tiết</button>
                                                        </td>
