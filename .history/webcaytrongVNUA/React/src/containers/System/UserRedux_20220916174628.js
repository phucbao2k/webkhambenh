...
handleEditUserFromParent = (user)=>{
  ...
  <div  className="col-12 my-3">
    <button
    ></button>
  <buttonclassName={this.state.action === CRUD_ACTIONS.EDIT? "btn btn-warning":"btn btn-primary"} type="submit"
  onClick={()=>this.handleSaveUser()}>  <FormattedMessage id="create-user.submit"/></buttonclassName=>
  </div>
