...
import './ManageHand.scss';
import TableManageHand from '../TableManageHand';
...
class ManageHand extends Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageHand);
