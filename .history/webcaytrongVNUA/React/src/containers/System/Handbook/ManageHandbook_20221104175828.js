...
class ManageHandbook extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.handbookRedux !== this.props.handbookRedux) {
            let arrSpecialties = this.props.handbookRedux;
            this.setState({
                handbookArr: arrSpecialties,
                handbook: arrSpecialties && arrSpecialties.length > 0 ? arrSpecialties[0].keyMap : '',
            })
        }
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                <label htmlFor="validationServerUsername">Handbook's name</label>
