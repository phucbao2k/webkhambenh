...
class ManageSpecialty extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.specialityRedux !== this.props.specialityRedux) {
            let arrSpecialtys = this.props.specialityRedux;
            this.setState({
                specialityArr: arrSpecialtys,
                speciality: arrSpecialtys && arrSpecialtys.length > 0 ? arrSpecialtys[0].keyMap : '',
            })
        }
        if (prevProps.listSpecialtys !== this.props.listSpecialtys) {
            ...
            this.setState({
                name: '',
                address: '',
                specialty: arrSpecialtys && arrSpecialtys.length > 0 ? arrSpecialtys[0].keyMap : '',
                avatar: '',
...
const mapStateToProps = state => {
    return {
        ...
        listSpecialtys: state.admin.specialitys
    };
};
