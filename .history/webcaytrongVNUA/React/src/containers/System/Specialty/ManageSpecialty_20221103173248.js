...
class ManageSpecialty extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.specialityRedux !== this.props.specialityRedux) {
            let arrSpecialties = this.props.specialityRedux;
            this.setState({
                specialityArr: arrSpecialties,
                speciality: arrSpecialties && arrSpecialties.length > 0 ? arrSpecialties[0].keyMap : '',
            })
        }
...
const mapStateToProps = state => {
    return {
        ...
        listSpecialties: state.admin.specialitys
    };
};
