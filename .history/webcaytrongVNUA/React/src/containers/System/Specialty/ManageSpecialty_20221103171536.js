...
class ManageSpecialty extends Component {
    ...
    async componentDidMount() {
        ...
        this.props.getSpeciaStart();

    }
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.clinicRedux !== this.props.clinicRedux) {
            let arrSpecias = this.props.clinicRedux;
            this.setState({
                clinicArr: arrSpecias,
                clinic: arrSpecias && arrSpecias.length > 0 ? arrSpecias[0].keyMap : '',
            })
        }
        if (prevProps.listSpecias !== this.props.listSpecias) {
            let arrSpecias = this.props.clinicRedux;
            this.setState({
                name: '',
                address: '',
    ...
    handleEditSpeciaFromParent = (clinic) => {
        let imageBase64 = '';
        if (clinic.image) {
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                <label htmlFor="validationServerUsername">Specia's name</label>
                        ...
                        <div className="col-12 mb-5">
                            <TableManageSpecialty
                                handleEditSpeciaFromParentKey={this.handleEditSpeciaFromParent}
...
const mapStateToProps = state => {
    return {
        ...
        listSpecias: state.admin.clinics
    };
};
...
const mapDispatchToProps = dispatch => {
    return {
        getSpeciaStart: () => dispatch(actions.fetchAllSpeciaStart()),
        createNewSpecia: (data) => dispatch(actions.createNewSpecia(data)),
        editSpeciaRedux: (data) => dispatch(actions.editSpecia(data))
    };
};
