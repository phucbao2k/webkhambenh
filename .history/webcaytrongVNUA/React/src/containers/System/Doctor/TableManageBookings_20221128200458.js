...
class TableManageBookings extends Component {
    ...
    async componentDidMount() {
        this.props.fetchBookingDoctorRedux();
        this.getDataPatient();
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.listBookings !== this.props.listBookings) {
            this.setState({
                bookingsDoctorRedux: this.props.listBookings,
            })
        }
            ...
            <React.Fragment>
                <div className="users-container">
                    ...
                    <div className="col-12 users-table mt-3 mx-1">
                        <div className="title">Lịch sử lịch hẹn</div>
...
const mapDispatchToProps = dispatch => {
    return {
        fetchBookingDoctorRedux: () => dispatch(actions.fetchAllBookingAdminStart()),
