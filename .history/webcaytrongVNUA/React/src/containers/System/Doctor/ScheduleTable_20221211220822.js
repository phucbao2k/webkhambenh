...
import { getAllPaidBookingForDoctor, postSendSchedule } from '../../../services/userService';
                                                ...
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button className="mp-btn-confirm" onClick={()=> this()}><FormattedMessage id="patient.booking-modal.check" /></button>
                                                            <button className="mp-btn-confirm"
                                                                onClick={() => this.handleBtnCancel(item)}>Thông báo đặt lại lịch hẹn</button>
                                                        </td>
                                                    </tr>
                                                )
                                            })
