...
class ManagePatient extends Component {
    ...
    handleViewBooking = (booking) => {
        this.props.handleViewBookingFromParentKey(booking)
    }
    ...
    handleBtnConfirm = (item) => {
        let data ={          
            ...
            avatar: new Buffer(booking.image, 'base64').toString('binary');,
    ...
    handleViewBookingFromParent = (booking) => {
        let imageBase64 = '';
        if (booking.image) {
            imageBase64 = new Buffer(booking.image, 'base64').toString('binary');
