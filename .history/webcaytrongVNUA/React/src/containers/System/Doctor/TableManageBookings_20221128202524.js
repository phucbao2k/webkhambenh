...
import { getHistoryPatientForDoctor, postSendRemedy, postCancelRemedy } from '../../../services/userService';
...
class TableManageBookings extends Component {
    ...
    getDataPatient = async () => {
        ...
        let res = await getHistoryPatientForDoctor({
            doctorId: user.id,
            date: formatedDate
        })
                                                ...
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button onClick={() => this.handleEditUserFromParent(item)}>Xem chi tiết</button>
                                                            <button className="mp-btn-confirm"
