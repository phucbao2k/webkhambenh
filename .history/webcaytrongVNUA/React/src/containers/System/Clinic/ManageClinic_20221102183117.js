...
class ManageClinic extends Component {
    ...
    render() {
        ...
        let { name, address, gender, clinic
            , avatar } = this.state;
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                <label htmlFor="validationServerUsername">Clinic</label>
                        ...
                        <div className="row">
                            ...
                            <div className="form-group col-md-3 mb-3">
                                <label htmlFor="validationServerUsername">Clin</label>
                        ...
                        <div className="col-12 mb-5">
                            <TableManageClinic
                                handleEditClinicFromParentKey={this.handleEditClincFromParent}
