...
class ManageClinic extends Component {
    ...
    handleEditClinicFromParent = (clinic) => {
        ...
        this.setState({
            ...
            contentHTML: clinic.contentMarkdown
        })
    }
                ...
                <div className="user-redux-body">
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-3">
                                <label htmlFor="validationServer03"> HTML</label>
                                <input type="text" className="form-control " id="validationServer03" placeholder="..." required
                                    value={contentHTML}
                                    onChange={(event) => { this.onChangeInput(event, 'contentHTML') }} />
                            ...
                            <div className="col-md-6 mb-3">
                                ...
                                <input type="text" className="form-control " id="validationServer03" placeholder="..." required
                                    ...
                                    onChange={(event) => { this.onChangeInput(event, 'contentMarkdown') }} />
