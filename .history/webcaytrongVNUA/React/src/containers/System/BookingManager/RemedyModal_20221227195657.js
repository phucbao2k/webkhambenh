...
class RemedyModal extends Component {
    ...
    async componentDidMount() {
        ...
        if (this.props.dataP) {
            this.setState({
                email: this.props.dataP.email,
                phoneNumber: this.props.dataP.phoneNumber,
                patientName: this.props.dataP.patientName,
                address: this.props.dataP.address,
                plantName: this.props.dataP.plantName,

                reasons: this.props.dataP.reasons,
                price: this.props.dataP.price,
                doctorName: this.props.dataP.doctorName
            })
        }
    }
