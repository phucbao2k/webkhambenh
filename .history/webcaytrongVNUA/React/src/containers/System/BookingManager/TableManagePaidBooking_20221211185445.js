...
import './TableManagePaidBooking.scss';

import { getAllPaidBookingForAdminBooking } from '../../../services/userService';
import moment from 'moment';

import RemedyPatientModal from '../Doctor/RemedyPatientModal';
// nếu muốn import 1 function thì ta dùng dấu ngoặc nhọn
class TableManagePaidBooking extends Component {
            ...
            <React.Fragment>
                <div className="users-container">
                    ...
                    <div className="col-12 users-table mt-3 mx-1">
                        ...
                        <table id="TableManagePaidBooking" style={{ width: '100%' }}>
                            <tbody>
                                <tr>
...
export default connect(mapStateToProps, mapDispatchToProps)(TableManagePaidBooking);
