...
class RemedyModal extends Component {
    ...
    goToExport = () => {
        if (this.props.history) {
            this.props.history.push(`/export-pdf`)
        }
    }
    render() {
        ...
        return (
           ...
           centered>
            ...
            <ModalFooter>
                    ...
                    <button onClick={() => this.goToExport()}>Export PDF</button>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Re));
