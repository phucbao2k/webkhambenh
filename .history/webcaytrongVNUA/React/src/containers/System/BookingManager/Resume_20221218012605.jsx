...
import { withRouter } from 'react-router';
 class Resume extends Component {
    ...
    render() {
        ...
        let { dataPatient, isOpenRemedyModal, dataModal } = this.props;
                ...
                <div className={'page ' + this.state.view}>
                    ...
                    <div className="dataModal">
                        ...
                        <div className="profile">
                            ...
                            <div
                                className="info name"
                                dangerouslySetInnerHTML={{ __html: this.props.dataModal.firstName }}
                            />
                            <div className="info birthday">{this.props.dataModal.time}</div>
                            <div className="info email">{this.props.dataModal.email}</div>

                            <div className="info phone">{this.props.dataModal.phoneNumber}</div>
                            <div className="info location">{this.props.dataModal.address}</div>
                            <div className="info plantName">

                                {this.props.dataModal.plantName}
                            </div>
                            <div className="info plantName">

                                {this.props.dataModal.phoneNumber}
                            </div>
