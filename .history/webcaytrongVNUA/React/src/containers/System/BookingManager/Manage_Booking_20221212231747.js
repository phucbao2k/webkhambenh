...
class Manage_Booking extends Component {
    ...
    get renderMovies() {
        let dataPatient = <h1>There's no dataPatient</h1>;
        if (this.state.dataPatient) {
            dataPatient = <dataPatients list={this.state.dataPatient} />;
        }
            ...
            <>
                <LoadingOverLay active={this.state.isShowLoading}
                    ...
                    <div className="manage-patient-container">
                        ...
                        <input type="" className="col-4 search-booking-box" placeholder='Search...' 
                        />
