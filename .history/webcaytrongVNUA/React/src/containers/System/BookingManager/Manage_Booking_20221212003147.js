...
class Manage_Booking extends Component {
    ...
    globalSearch = async  () => {
        ...
        if (res && res.errCode === 0) {
            ...
            console.log('check filtered Data', data)
        }
    ...
    render() {
        ...
        let { dataPatient, isOpenRemedyModal, dataModal, searchInput,data} = this.state;
                                ...
                                <table style={{ width: '100%' }}>
                                    <tbody>
                                        <tr>
                                            ...
                                            <th accessor: "firstName",
        sortable: false,
        show: true,><FormattedMessage id="patient.booking-modal.email" /></th>
                                        ...
                                        {dataPatient && dataPatient.length > 0 ? data = { data } &&
