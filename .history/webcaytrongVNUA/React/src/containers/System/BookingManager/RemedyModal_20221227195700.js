    ...
    async componentDidMount() {
        ...
        if (this.props.dataPatient) {
            this.setState({
                ...
                patientName: this.props.dataPatient.patientName,
                address: this.props.dataPatient.address,
                plantName: this.props.dataPatient.plantName,

                reasons: this.props.dataPatient.reasons,
                price: this.props.dataPatient.price,
                doctorName: this.props.dataPatient.doctorName
            })
        }
    }
