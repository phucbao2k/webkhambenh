...
class TableManageHandbook extends Component {
    ...
    handleDeleteHandbook = (specialty) => {
        this.props.deleteHandbookRedux(specialty.id);
    }

    handleEditHandbook = (specialty) => {
        this.props.handleEditHandbookFromParentKey(specialty)
    }
