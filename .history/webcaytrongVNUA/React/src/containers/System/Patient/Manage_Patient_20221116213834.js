...
class Manage_Patient extends Component {
    ...
    render() {
        ...
        let { isOpenRemedyModal, dataModal, avatar } = this.state;
        let arrPatientBookings = this.state.bookingsPatientRedux;
        return (
            <>
                            ...
                            <div className="col-12 table-manage-patient">
                                <table style={{ width: '100%' }}>
                                    <tbody>
                                        ...
                                        {arrPatientBookings && arrPatientBookings.length > 0 ?
                                            arrPatientBookings.map((item, index) => {
