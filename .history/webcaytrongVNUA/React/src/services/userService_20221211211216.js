...
const getAllPaidBookingForAdminBooking = (data) => {
    return axios.get(`/api/get-all-paid-booking-for-admin-booking?statusId=${data.statusId}&date=${data.date}& doctorId=${data.doctorId}`)
}
...
const getAllPaidBookingForDoctor = (data) => {
    return axios.get(`/api/get-all-paid-booking-for-doctor?statusId=${data.statusId}&date=${data.date}`)
}
