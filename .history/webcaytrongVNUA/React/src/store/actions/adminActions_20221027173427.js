...
import {
    ...
    , saveDetailDoctorService, getAllSpecialty, getAllClinic, getTopDoctorSpecialtyService
...
export const fetchTopDoctorSpecialty = () => {
    return async (dispatch, getState) => {
        try {
            let res = await getTopDoctorSpecialtyService(inputId);
            ...
            console.log('FETCH_TOP_DOCTORS_SPECIALTFAILED', e)
            dispatch({
                type: actionTypes.FETCH_TOP_DOCTORS_SPECIALTFAILED
            })
        }
    }
}
