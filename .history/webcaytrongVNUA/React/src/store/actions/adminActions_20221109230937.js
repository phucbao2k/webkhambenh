...
import {
    ...
    createNewHandbookService, deleteHandbookService, editHandbookService, showAllHandbooks, getAllBookingForAdmin, deleteBookingService
...
export const deleteBooking = (bookingId) => {
    return async (dispatch, getState) => {
        try {
            let res = await deleteBookingService(bookingId);
            if (res && res.errCode === 0) {
