...
import {
    ...
    createNewHandbookService, deleteHandbookService, editHandbookService, showAllHandbooks, deleteBooking, getAllBookings, saveScheduleDoctorService
    ...
    return async (dispatch, getState) => {
        try {
            ...
            if (res && res.errCode === 0) {
                toast.success("Update success!");
                dispatch({
                    type: actionTypes.SAVE_S_DOCTOR_SUCCESS,
                ...
                toast.error('Error');
                dispatch({
                    type: actionTypes.SAVE_S_DOCTOR_FAILED
                })
            }
        } catch (e) {
            toast.error('Error');
            console.log('SAVE_S_DOCTOR_FAILED', e)
            dispatch({
                type: actionTypes.SAVE_S_DOCTOR_FAILED
            })
        }
