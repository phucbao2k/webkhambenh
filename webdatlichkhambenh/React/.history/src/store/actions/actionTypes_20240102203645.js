const actionTypes = Object.freeze({
  ...
  FETCH_USERS_BY_ROLE_ID_SUCCESS: 'FETCH_USERS_BY_ROLE_ID_SUCCESS',
  FETCH_USERS_BY_ROLE_ID_FAILED: 'FETCH_USERS_BY_ROLE_ID_FAILED',
  FETCH_ADMIN_BY_ROLE_ID_SUCCESS: 'FETCH_ADMIN_BY_ROLE_ID_SUCCESS',
  FETCH_ADMIN_BY_ROLE_ID_FAILED: 'FETCH_ADMIN_BY_ROLE_ID_FAILED',
  FETCH_ADMIN_BOOKING_BY_ROLE_ID_SUCCESS: 'FETCH_ADMIN_BOOKING_BY_ROLE_ID_SUCCESS',
  FETCH_ADMIN_BOOKING_BY_ROLE_ID_FAILED: 'FETCH_ADMIN_BOOKING_BY_ROLE_ID_FAILED',
  FETCH_DOCTOR_BY_ROLE_ID_SUCCESS: 'FETCH_DOCTOR_BY_ROLE_ID_SUCCESS',
  FETCH_DOCTOR_BY_ROLE_ID_FAILED: 'FETCH_DOCTOR_BY_ROLE_ID_FAILED',
  FETCH_USER_NOT_DOCTOR_SUCCESS: 'FETCH_USER_NOT_DOCTOR_SUCCESS',
  FETCH_USER_NOT_DOCTOR_FAILED: 'FETCH_USER_NOT_DOCTOR_FAILED',
  FETCH_REQUIRED_USER_NOT_DOCTOR_INFOR_START: 'FETCH_REQUIRED_USER_NOT_DOCTOR_INFOR_START',
  FETCH_REQUIRED_USER_NOT_DOCTOR_INFOR_SUCCESS: 'FETCH_REQUIRED_USER_NOT_DOCTOR_INFOR_SUCCESS',
  FETCH_REQUIRED_USER_NOT_DOCTOR_INFOR_FAILED: 'FETCH_REQUIRED_USER_NOT_DOCTOR_INFOR_FAILED',
  SAVE_DETAIL_USER_NOT_DOCTOR_SUCCESS: 'SAVE_DETAIL_USER_NOT_DOCTOR_SUCCESS',
  SAVE_DETAIL_USER_NOT_DOCTOR_FAILED: 'SAVE_DETAIL_USER_NOT_DOCTOR_FAILED',
