...
class VNPayPaymentButton extends Component {
    ...
    handlePayment = () => {
        try {
            ...
            const redirectUrl = `this/order/create_payment_url?amount=${amount}&bankCode=&orderDescription=Payment+for+online+appointment+booking&orderType=billpayment&language=vn`;
