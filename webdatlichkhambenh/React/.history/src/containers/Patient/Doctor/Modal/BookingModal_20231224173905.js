...
class BookingModal extends Component {
    ...
    // Mở liên kết trong cửa sổ mới
          window.open(`${this.apiUrl}/order/querydr`, '_blank');
  };
    ...
    handleConfirmBooking = async () => {
        ...
        if (res && res.errCode === 0) {
            toast.success("Booking success! Please check your email to confirm!")
                ...
                <Modal
                    ...
                    <div className="booking-modal-content" >
                        <div className="booking-modal-header">
                            ...
                            <span className="right"><FormattedMessage id="patient.booking-modal.note" /></span>
                        ...
                        <div className="booking-modal-footer">
                            ...
                            <div className="note"> <FormattedMessage id="patient.booking-modal.note2" /></div>
                        ...
                        <div className="booking-modal-footer">
                            ...
                            <button className="btn-booking-check"
                                onClick={this.openApiLink}>
                                Đã thanh toán nhưng bị lỡ hẹn? Tra cứu kết quả thanh toán với mã giao dịch để được sắp lịch khám mới tại đây...
                            </button>
                        </div>
                    </div>
