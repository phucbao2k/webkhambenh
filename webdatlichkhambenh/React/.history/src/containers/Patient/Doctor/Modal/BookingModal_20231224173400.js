...
class BookingModal extends Component {
    ...
    handleConfirmBooking = async () => {
        ...
        if (res && res.errCode === 0) {
            toast.success("Booking a new appointment succeed! Hãy kiểm tra email của bạn để xác nhận!")
                ...
                <Modal
                    ...
                    <div className="booking-modal-content" >
                        <div className="booking-modal-header">
                            ...
                            <span className="right"><FormattedMessage id="patient.booking-modal.title" /></span>
