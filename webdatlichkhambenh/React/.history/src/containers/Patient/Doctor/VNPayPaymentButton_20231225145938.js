...
class VNPayPaymentButton extends Component {
    ...
    handlePayment = () => {
        try {
            ...
            const redirectUrl = `/order/create_payment_url?amount=${amount}&bankCode=NCB&orderDescription=Payment+for+online+appointment+booking&orderType=billpayment&language=vn`;
