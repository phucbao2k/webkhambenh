...
import {SearchDoctor from '../HomePage/Section/SearchDoctor';
    ...
    render() {
        ...
        return (
            <React.Fragment>
                                ...
                                <div className='row p-0 m-0'>
                                    <div className='col-12 p-0 py-2'>
                                        <div className='d-flex justify-content-between align-items-center menu__header'>
                                            ...
                                            {/* Hiển thị các menu khi SearchBar không hiển thị */}
                                            ...
                                            {/* Hiển thị hoặc ẩn nút hiển thị SearchDoctor */}
                                            <div className={`menu__item hide__576 ${searchDoctorVisible ? 'hide' : ''}`} onClick={this.toggleSearchDoctor}>
                                                <div><i className='fa-solid fa-search' /></div>
                                                <div className='sub-title'> <FormattedMessage id='homeheader.search' /></div>
                                            </div>

                                            {/* Hiển thị hoặc ẩn nút đóng SearchDoctor */}
                                            <div className={`menu__item hide__576 ${!searchDoctorVisible ? 'hide' : ''}`} onClick={this.toggleSearchDoctor}>
                ...
                {/* Hiển thị hoặc ẩn component SearchDoctor tùy thuộc vào trạng thái */}
