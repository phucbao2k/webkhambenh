...
class SearchDoctor extends Component {
    ...
    fetchData = async () => {
        try {
            ...
            response.data.forEach(result => {
                ...
                const isDuplicate = uniqueResults.some(uniqueResult => (
                    uniqueResult.id === result.id && uniqueResult.valueVi === result.valueVi && uniqueResult.valueEn === result.valueEn
                ));
            ...
            // Hiển thị thông báo lỗi cho người dùng hoặc xử lý khác
        }
    };
    ...
    // Ví dụ xử lý sự kiện click trong dropdown
