...
class DoctorDetail extends Component {
    ...
    componentDidUpdate() {
        ...
        if (selectedDoctor && selectedDoctor.doctorId && this.state.doctorId !== selectedDoctor.doctorId) {
            this.setState({ doctorId: selectedDoctor.doctorId });
        }
    }
                        ...
                        {selectedDoctor.doctors.map((doctor, index) => (
                            <div key={index} className="doctor-info">
                                ...
                                <div className="button-container">
                                    <Button
                                        color="primary"
                                        onClick={() => this.handleViewDetailDoctor(doctor.doctorId)}
                                    >
