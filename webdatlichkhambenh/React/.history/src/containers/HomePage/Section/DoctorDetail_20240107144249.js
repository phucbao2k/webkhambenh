...
class DoctorDetail extends Component {
    ...
    componentDidMount() {
        ...
        if (storedDoctor && storedDoctorId) {
            this.setState({
                selectedDoctor: storedDoctor,
    ...
    componentDidUpdate(prevProps, prevState) {
        // Lưu trữ thông tin vào localStorage khi selectedDoctor thay đổi
        if (this.state.selectedDoctor !== prevState.selectedDoctor) {
            localStorage.setItem('selectedDoctor', JSON.stringify(this.state.selectedDoctor));
