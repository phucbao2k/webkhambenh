    ...
    render() {
        ...
        return (
            <div className="search-bar-container">
                ...
                {selectedDoctor && (
                    <div>
                        <h2>Thông tin chi tiết của bác sĩ</h2>
                        <p>ID: {selectedDoctor.id}</p>
                        <p>Specialty ID: {selectedDoctor.specialtyId}</p>
                        <p>Clinic ID: {selectedDoctor.clinicId}</p>
                        <p>Price ID: {selectedDoctor.priceId}</p>
                        <p>Province ID: {selectedDoctor.provinceId}</p>
                        <p>Payment ID: {selectedDoctor.paymentId}</p>
                        <p>Address Clinic: {selectedDoctor.addressClinic}</p>
                        <p>Name Clinic: {selectedDoctor.nameClinic}</p>
