...
class DoctorDetail extends Component {
    ...
    componentDidUpdate() {
        ...
        if (selectedDoctor && selectedDoctor.id && this.state.doctorId !== selectedDoctor.id) {
            this.setState({ doctorId: selectedDoctor.id });
        }
    }
                ...
                {selectedDoctor && (
                    <>
                        ...
                        <div className="button-container">
                            <Button color="primary" onClick={this.handleViewDetailDoctor}>
