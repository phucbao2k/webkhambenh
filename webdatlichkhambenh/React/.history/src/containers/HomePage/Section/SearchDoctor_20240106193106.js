...
class SearchDoctor extends Component {
    ...
    handleItemClick = async (result) => {
        ...
        try {
            // Implement your logic for handling item click, e.g., fetching additional details
            // const additionalDetails = await fetchAdditionalDetails(result.id);
            // const selectedDoctor = { ...result, ...additionalDetails };
