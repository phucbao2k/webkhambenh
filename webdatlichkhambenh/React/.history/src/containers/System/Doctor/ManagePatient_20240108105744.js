// CLASS HIỂN THỊ LỊCH KHÁM KHÁCH HÀNG ĐÃ XÁC NHẬN THEO NGÀY
...
class ManagePatient extends Component {
    ...
    calculateAge = (birthday) => {
        ...
        const birthDate = moment(birthday, 'YYYY-MM-DD'); // Thay 'YYYY-MM-DD' bằng định dạng ngày sinh thực tế của bạn
        ...
        return (
            ...
            text='Loading...'>
                    <div className="manage-patient-container">
                        <div className="m-p-title"><FormattedMessage id="patient.booking-modal.manage-patient-booking" /></div>
