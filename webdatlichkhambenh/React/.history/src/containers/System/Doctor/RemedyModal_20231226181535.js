// MODAL CHỨA THÔNG TIN LỊCH KHÁM KÈM CÁC THÔNG TIN GỬI CHO KHÁCH HÀNG TRƯỚC KHI KHÁM HAY ĐẠI LOẠI VẬY.
           ...
           className={'booking-modal-container'}
            ...
            <ModalBody>
                    <div className="row">
                        ...
                        <div className="col-8 form-group">
                            <label><FormattedMessage id="patient.booking-modal.pre-booking" /></label>
