...
import TableManageBookingManager from './TableManageBookingManager.js';
import TableManageDoctor from './TableManageDoctor.js';
  ...
  handleSaveUser = async () => {
    ...
    if (action === CRUD_ACTIONS.CREATE) {
      this.props.createNewUser({
        ...
        newPositionId: this.state.position,
