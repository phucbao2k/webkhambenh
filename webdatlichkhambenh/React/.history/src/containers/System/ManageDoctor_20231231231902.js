...
class ManageDoctor extends Component {
    ...
    handleSaveContentMarkdown = () => {
        ...
        let selectedRole = ''; // Lưu trữ vai trò của người dùng được chọn

        // Kiểm tra xem người dùng đã chọn bác sĩ hay người dùng thông thường chưa
        ...
        // Dựa vào vai trò, thực hiện hành động tương ứng
        if (selectedRole === 'doctor') {
            ...
            // Người dùng đã chọn người dùng thông thường
            this.props.saveDetailUserNotDoctor({
                // Thêm các thông tin cần lưu cho người dùng thông thường
                // ...
            });
        }
    }
