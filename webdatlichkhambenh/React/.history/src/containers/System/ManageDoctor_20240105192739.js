...
class ManageDoctor extends Component {
    ...
    handleSaveContentMarkdown = async () => {
        ...
        this.props.updateDoctorDetails({ positionId: newPositionId, phoneNumber: newPhoneNumber, positionId: newPositionId, phoneNumber: newPhoneNumber, valueVi: this.state.newPositionValueVi, newPositionValueEn: this.state.newPositionValueEn });
    };
