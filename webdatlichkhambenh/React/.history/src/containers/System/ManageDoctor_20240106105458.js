...
class ManageDoctor extends Component {
    ...
    handleSaveContentMarkdown = async () => {
        ...
        if (!this.state.newPositionValueVi || !this.state.newPositionValueEn) {
            toast.error("Invalid position values");
            errors.push("newPositionValueVi", "newPositionValueEn");
        }
        ...
        console.log('newPositionValueVi:', this.state.valueVi);
        console.log('newPositionValueEn:', this.state.valueEn);
        this.props.updateDoctorDetails({  positionId: newPositionId, phoneNumber: newPhoneNumber, valueVi: this.state.newPositionValueVi, valueEn: this.state.newPositionValueEn });
    };
    ...
    handleChangeSelect = async (selectedDoctor) => {
        ...
        if (res && res.errCode === 0 && res.data && res.data.Markdown) {
            ...
            let addressClinic = '', nameClinic = '', positionId = '', 
                ...
                clinicId = '', selectedClinic = '', phoneNumber = '', selectedPosition = '', valueEn ='',
                valueVi=''
                ;
            if (res.data.Doctor_Infor) {
                addressClinic = res.data.Doctor_Infor.addressClinic;
                nameClinic = res.data.Doctor_Infor.nameClinic;
                valueEn = res.data.Doctor_Infor.valueEn;
                valueVi = res.data.Doctor_Infor.valueVi;
    ...
    handleChangeSelectDoctorInfor = async (selectedDoctor, name) => {
        ...
        if (stateName === 'newPositionValueVi' || stateName === 'newPositionValueEn') {
            // Xử lý các trường hợp đặc biệt
            let valueVi = '';
            let valueEn = '';

            // Thực hiện logic để đặt giá trị cho valueVi và valueEn dựa trên selectedDoctor
            // In ra để kiểm tra
            console.log('Computed values for newPositionValueVi and newPositionValueEn:', valueVi, valueEn);

            this.setState({
                newPositionValueVi: valueVi,
                newPositionValueEn: valueEn,
            });
        } else {
            this.setState({
