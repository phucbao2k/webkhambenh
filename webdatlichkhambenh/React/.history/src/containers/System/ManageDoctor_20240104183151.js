...
class ManageDoctor extends Component {
    ...
    handleSaveContentMarkdown = async () => {
        ...
        this.props.saveDetailDoctor({
            ...
            newPositionValueVi: this.state.newPositionValueVi,
            newPositionValueEn: this.state.newPositionValueEn // Sử dụng giá trị từ state
    ...
    handleChangeSelectDoctorInfor = async (selectedDoctor) => {
        let stateName = name.name;
        let stateCopy = { ...this.state };
        stateCopy[stateName] = selectedDoctor;
        this.setState({
            ...stateCopy,
            newPositionValueVi: res.data.newPositionValueVi,
            newPositionValueEn: res.data.newPositionValueEn
        })
    }
