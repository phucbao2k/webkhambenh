...
class ManageDoctor extends Component {
    ...
    componentDidMount() {
        ...
        this.props.fetchUserNotDoctors()
        //tất cả dữ liệu lấy được từ fetchAllDoctors, getAllRequiredDoctorInfor sẽ được ghi vào props cha, cụ thể là this.props;
                ...
                .then(res => {
                    if (res && res.errCode === 0) {
                        ...
                        this.props.saveDetailDoctor({
                            ...
                            selectedPrice: this.state.selectedPrice.valueVi,
    ...
    handleChangeSelectUserNotDoctor = async (selectedUser) => {
        let stateName = 'selectedUserNotDoctor';
        let stateCopy = { ...this.state };
        stateCopy[stateName] = selectedUser;
        this.setState({
            ...stateCopy
        });
    };
