...
class ManageDoctor extends Component {
    ...
    handleSubmit() {
        ...
        if (this.state.selectedDoctor === "" || this.state.selectedUserNotDoctor === "") {
    ...
    handleSaveContentMarkdown = () => {
        ...
        if (this.state.selectedDoctor) {
            selectedRole = 'doctor';
        } else if (this.state.selectedUserNotDoctor) {
            selectedRole = 'userNotDoctor';
        }
        ...
        } else if (selectedRole === 'userNotDoctor') {
            // Log ID người dùng trước khi gọi hàm
            console.log('Selected User ID:', this.state.selectedUserNotDoctor.value);

            let stateCopy = { ...this.state };
            delete stateCopy.selectedDoctor;

            this.props.saveDetailUserNotDoctor({
                ...stateCopy,
                contentHTML: this.state.contentHTML,
                contentMarkdown: this.state.contentMarkdown,
                description: this.state.description,
                        ...
                        <div className=" more-infor-extra row">
                            ...
                            <div className="form-group col-md-3 mb-3">
                                ...
                                <select id="inputState" className="form-control"
                                    onChange={(event) => { this.handleOnChangePosition(event, 'position') }}
                                    value={position}>
