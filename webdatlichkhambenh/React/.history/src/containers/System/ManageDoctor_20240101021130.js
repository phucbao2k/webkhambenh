...
class ManageDoctor extends Component {
    ...
    handleChangeSelectUserNotDoctor = async (selectedUserNotDoctor) => {
        ...
        let { listPayment, listPrice, listProvince, listSpecialty, listClinic, lis } = this.state;
        ...
        if (res && res.errCode === 0 && res.data && res.data.Markdown) {
            ...
            if (res.data.Doctor_Infor) {
                ...
                selectedPosition = listPosition.find(item => {
                    return item && item.value === positionIdId
                })
            }
            this.setState({
                contentHTML: markdown.contentHTML,
    ...
    handleOnChangePosition = (event, id) => {
        let stateCopy = { ...this.state };
        stateCopy[id] = event.target.value;
        this.setState({
            ...stateCopy
    ...
    render() {
        ...
        let { hasOldData, position } = this.state;
