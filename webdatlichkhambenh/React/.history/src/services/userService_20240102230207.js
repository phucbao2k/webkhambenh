...
const getUsersByRoleId =  () => {
    return axios.get(`/api/get-users-by-role`)
};
const getAdminByRoleId = (roleId) => {
    return axios.get(`/api/get-admin-by-role?roleId=${roleId}`)
};
const getDoctorByRoleId = (roleId) => {
    return axios.get(`/api/get-doctor-by-role?roleId=${roleId}`)
};
const getAdminBookingByRoleId = (roleId) => {
    return axios.get(`/api/get-admin-booking-by-role?roleId=${roleId}`)
};
...
const getUserNotDoctors = () => {
    return axios.get(`/api/get-all-users-not-doctor`)
}
const saveDetailUserNotDoctorService = (data) => {
    return axios.post('/api/save-infor-users-not-doctor', data)
}

const getDetailInforUserNotDoctor = (inputId) => {
    return axios.get(`/api/get-detail-users-not-doctor-by-id?id=${inputId}`)
}
...
const saveScheduleDoctorService = (data) => {
    return axios.post('/api/save-schedule-doctors', data)
}
...
export {
    ...
    saveDetailUserNotDoctorService,
    getDetailInforUserNotDoctor,
    getUsersByRoleId,
    getAdminByRoleId,
    getDoctorByRoleId,
    getAdminBookingByRoleId
