...
import Manage_Booking from '../containers/System/BookingManager/Manage_Booking';
import SearchableTable from '../containers/System/BookingManager/SearchableTable';
            ...
            <React.Fragment>
                ...
                <div className="container system-container">
                    <div className="system-list">
                        <Switch>
                            <Route path="/booking-manager/search_booking" component={SearchableTable} />
                            <Route path="/booking-manager/manage_booking" component={Manage_Booking} />
                        </Switch>
                    </div>
                </div>
            </React.Fragment>
