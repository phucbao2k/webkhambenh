...
class TableManageBookingManager extends Component {
    ...
    componentDidMount() {
        this.props.fetchAdminBookingByRoleId();
    }

    componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.adminBooking !== this.props.adminBooking) {
            this.setState({
                listAdminBooking: this.props.adminBooking,
            });
        }
    }
    ...
    render() {
        const arrUsers = this.state.listAdminBooking;

        return (
            <React.Fragment>
                <div className="users-container">
                    <div className="title text-center">Manage Booking Manager</div>
...
const mapStateToProps = (state) => {
    return {
        adminBooking: state.admin.adminBooking,
    };
};

const mapDispatchToProps = (dispatch) => {
    return {
        fetchAdminBookingByRoleId: () => dispatch(actions.fetchAdminBookingByRoleId()),
