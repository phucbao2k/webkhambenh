    ...
    try {
        ...
        const result = await Doctor_Infor.findAll({
            ...
            include: [
                ...
                {
                    model: Specialty, // Thêm include cho bảng Specialty
                    as: 'specialtyData', // Đặt tên alias tùy ý
        ...
        const mappedResult = result.map(doctor => ({
            ...
            specialtyData: doctor.specialtyData, // Thêm thông tin từ bảng Specialty vào đây
        }));
