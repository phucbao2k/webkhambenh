...
// app.get('/get-search-booking-for-admin-booking', async (req, res) => {
//     try {
...
//               WHERE
//                 CONCAT(Users.id, Users.firstName, Users.lastName, Users.phoneNumber) LIKE :searchTerm
//                 OR Bookings.reasons LIKE :searchTerm
//                 OR Bookings.date LIKE :searchTerm
//                 OR Bookings.birthday LIKE :searchTerm
//                 OR Users.statusId LIKE :searchTerm;`,
//             {
