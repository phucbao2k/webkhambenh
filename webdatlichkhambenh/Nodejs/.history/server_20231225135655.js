...
router.post('/create_payment_url', function (req, res, next) {
    ...
    vnp_Params['vnp_vnp_TmnCode'] = vnp_TmnCode;
...
router.post('/querydr', function (req, res, next) {
    ...
    let data = vnp_RequestId + "|" + vnp_Version + "|" + vnp_Command + "|" + vnp_vnp_TmnCode + "|" + vnp_TxnRef + "|" + vnp_TransactionDate + "|" + vnp_CreateDate + "|" + vnp_IpAddr + "|" + vnp_OrderInfo;
    ...
    let dataObj = {
        ...
        'vnp_vnp_TmnCode': vnp_vnp_TmnCode,
...
router.post('/refund', function (req, res, next) {
    ...
    let data = vnp_RequestId + "|" + vnp_Version + "|" + vnp_Command + "|" + vnp_vnp_TmnCode + "|" + vnp_TransactionType + "|" + vnp_TxnRef + "|" + vnp_Amount + "|" + vnp_TransactionNo + "|" + vnp_TransactionDate + "|" + vnp_CreateBy + "|" + vnp_CreateDate + "|" + vnp_IpAddr + "|" + vnp_OrderInfo;
    let hmac = crypto.createHmac("sha512", secretKey);
    let vnp_SecureHash = hmac.update(new Buffer(data, 'utf-8')).digest("hex");
