...
app.post('/api/get-doctors-by-position', async (req, res) => {
    ...
    try {
        ...
        // Mapping dữ liệu với kiểm tra tồn tại
        const mappedResult = result.map(doctor => ({
            ...
            firstName: doctor.User ? doctor.User.firstName : null,
            lastName: doctor.User ? doctor.User.lastName : null,
            specialityData: {
                name: doctor.specialityData ? doctor.specialityData.name : null,
            },
        }));
