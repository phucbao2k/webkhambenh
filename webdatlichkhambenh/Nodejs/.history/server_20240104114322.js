...
app.post('/api/get-doctors-by-position', async (req, res) => {
    ...
    try {
        // Tìm keyMap tương ứng cho positionId
        const positionKeyMap = await Allcode.findOne({
            where: {
                type: 'POSITION',
                valueVi: positionId, // Giả sử valueVi chứa giá trị tương ứng với positionId trong Doctor_Infor
            },
            raw: true,
        });
        ...
        // Lấy thông tin bác sĩ với positionId tương ứng trong Doctor_Infor
