...
export default (sequelize) => {
    ...
    Doctor_Infor.beforeUpdate(async (instance) => {
        try {
            ...
            console.log("User found:", user); // Thêm log để xem đối tượng user
            ...
            if (user) {
                ...
                console.log("User not found for doctorId:", instance.doctorId);
            }
        } catch (error) {
            console.error("Error in Doctor_Infor.beforeUpdate:", error);
        }
    });
