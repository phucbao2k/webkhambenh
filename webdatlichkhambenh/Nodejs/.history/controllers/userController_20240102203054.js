...
let handleGetUsersByRoleId = async (req, res) => {
    ...
    let users = await userService.getAdminByRoleId(roleId);
...
let handleGetDoctorByRoleId = async (req, res) => {
    ...
    let doctor = await userService.getDoctorByRoleId(roleId);
...
let handleGetBookingManagerByRoleId = async (req, res) => {
    ...
    let adminBooking = await userService.getBookingManagerByRoleId(roleId);
...
export default {
    ...
    handleGetBookingManagerByRoleId
}