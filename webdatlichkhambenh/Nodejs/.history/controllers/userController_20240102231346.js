...
let handleGetUsersByRoleId = async (req, res) => {
    ...
    try {
        let adminBooking = await userService.getUsersByRoleId();
        //lấy hết tất cả logic của doctorService rồi gán vào hàm này
        return res.status(200).json(adminBooking)
    } catch (e) {
        console.log(e)
        return res.status(200).json
    }
...
let handleGetAdminByRoleId = async (req, res) => {
    ...
    try {
        let admin = await userService.getAdminByRoleId();
        //lấy hết tất cả logic của doctorService rồi gán vào hàm này
...
let handleGetDoctorByRoleId = async (req, res) => {
    try {
        let doctors = await userService.getDoctorByRoleId();
        //lấy hết tất cả logic của doctorService rồi gán vào hàm này
...
let handleGetBookingManagerByRoleId = async (req, res) => {
    ...
    try {
        let adminBooking = await userService.getAdminBookingByRoleId();
        //lấy hết tất cả logic của doctorService rồi gán vào hàm này
        return res.status(200).json(adminBooking)
    } catch (e) {
        console.log(e)
