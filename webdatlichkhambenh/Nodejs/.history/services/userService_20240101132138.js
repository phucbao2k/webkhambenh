...
const updateFields = async (userModel, doctorModel, userId, doctorId, newPhoneNumber, newPositionId) => {
    const updateUser = async () => {
        try {
            ...
            const result = await userModel.update(updateObject, {
                where: { id: userId },
                returning: true,
                plain: true,
            });
            ...
            return {
                success: false,
                error: error.message || "Error updating fields for User",
            };
        }
    };
    ...
    const updateDoctor = async () => {
        try {
            ...
            const result = await doctorModel.update(updateObject, {
                where: { doctorId },
                returning: true,
                plain: true,
            });
            ...
            return {
                success: false,
                error: error.message || "Error updating fields for Doctor_Infor",
            };
        }
    };

    return Promise.all([updateUser(), updateDoctor()]);
};

// Sử dụng hàm updateFields
updateFields(db.User, db.Doctor_Infor, userId, doctorId, newPhoneNumber, newPositionId)
