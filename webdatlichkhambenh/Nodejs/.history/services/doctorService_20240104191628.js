...
const getPositionInfoById = (positionId) => {
    // Thực hiện logic lấy thông tin position từ API hoặc dữ liệu cứng đã có
    // Trả về một đối tượng với valueEn và valueVi
    // Hoặc có thể gọi API để lấy thông tin position từ server
    // Ví dụ:
    switch (positionId) {
        case 'P1':
            return {
                valueEn: 'Senior Doctor',
                valueVi: 'Bác sĩ cao cấp',
            };
        case 'P2':
            return {
                valueEn: 'Doctor',
        ...
        case 'P3':
            return {
                valueEn: 'Junior Doctor',
                valueVi: 'Bác sĩ mới',
            };
        // Thêm các trường hợp khác nếu cần
        default:
            return null; // Hoặc xử lý theo logic của bạn nếu không tìm thấy positionId
    }
};
