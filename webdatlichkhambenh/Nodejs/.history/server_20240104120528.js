...
app.post('/api/get-doctors-by-position', async (req, res) => {
    ...
    try {
        // Tìm keyMap tương ứng cho positionId từ bảng Allcode
        const positionKeyMap = await Allcode.findOne({
            where: {
                type: 'POSITION',
                valueVi: positionId, // Đảm bảo giá trị positionId chính là valueVi trong bảng Allcode
            },
            raw: true,
        });
        ...
        // Lấy danh sách bác sĩ với positionId tương ứng trong bảng Doctor_Infor
