...
export function initWebRoutes(app) {
    ...
    router.get('/api/get-all-users-not-doctor', userController.handleGetUsersNotDoctor);
    router.post('/api/save-infor-users-not-doctor', userController.postInforUserNotDoctor);
    router.get('/api/get-detail-users-not-doctor-by-id', userController.getDetailUserNotDoctorById);
    router.post('/api/create-new-user', userController.handleCreateNewUser);
    router.get('/api/get-users-by-role', userController.handleGetUsersByRoleId);
    router.get('/api/get-admin-by-role', userController.handleGetAdminByRoleId);
    router.get('/api/get-doctor-by-role', userController.handleGetDoctorByRoleId);
    router.get('/api/get-admin-booking-by-role', userController.handleGetBookingManagerByRoleId);
