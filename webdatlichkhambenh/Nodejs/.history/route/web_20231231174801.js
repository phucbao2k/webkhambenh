...
export function initWebRoutes(app) {
    ...
    router.post('/api/save-infor-users-not-doctor', doctorController.postInforDoctor);
    router.get('/api/get-detail-users-not-doctor-by-id', doctorController.getDetailDoctorById);
